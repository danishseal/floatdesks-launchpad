...
### Launch app (`app/`, Next.js)
| Var | Value |
| --- | --- |
| `NEXT_PUBLIC_SOLANA_RPC_URL` | `https://mainnet.helius-rpc.com/?api-key=<HELIUS_KEY>` |
| `NEXT_PUBLIC_FLOORLAUNCH_API_URL` | `https://commas-indexer.fly.dev` |
| `NEXT_PUBLIC_FLOORLAUNCH_WS_URL` | `wss://commas-indexer.fly.dev/ws` |
| `NEXT_PUBLIC_PRIVY_APP_ID` | `cms4p9blf01o40cjm0wexxlzs` (unchanged) |

The app defaults to the hosted mainnet indexer. Override these variables only
for local development or a separately hosted indexer.
