...
| 2026-09-04 | session 01LqS83j | Adding DeskHook pools to the liquidity board. Owns `app/src/lib/float/desk-hook.ts` and `app/src/app/api/float/hook-pools/`. Not deployed anywhere yet, so the section is absent until it is. |
